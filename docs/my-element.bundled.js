 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */;function j(t){let s=O.get(t.type);void 0===s&&(s={stringsArray:new WeakMap,keyString:new Map},O.set(t.type,s));let e=s.stringsArray.get(t.strings);if(void 0!==e)return e;const n=t.strings.join(i);return e=s.keyString.get(n),void 0===e&&(e=new o(t,t.getTemplateElement()),s.keyString.set(n,e)),s.stringsArray.set(t.strings,e),e}const O=new Map,U=new WeakMap;
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
class{handleAttributeExpressions(t,s,i,e){const n=s[0];if("."===n){return new M(t,s.slice(1),i).parts}return"@"===n?[new E(t,s.slice(1),e.eventContext)]:"?"===n?[new P(t,s.slice(1),i)]:new _(t,s,i).parts}handleTextExpression(t){return new A(t)}};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
class K extends G{constructor(){super()}updated(){const t=this.shadowRoot.getElementById("paypal-buttons");console.log("containerElementRef",this.shadowRoot),window.paypal.Buttons().render(t)}render(){return N`
      <div id="paypal-buttons"></div>
    `}}window.customElements.define("paypal-buttons",K);export{K as PayPalButtons};
